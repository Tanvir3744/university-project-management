...
export const generateStudentId = async (
  ...
  //20 25
  if (academicSemester) {
    incrementedId = `${academicSemester.year?.toString()}${academicSemester.code}${incrementedId}`;
  } else {
    console.log('something is wrong with academic semester in user.utils line 31')
  }
