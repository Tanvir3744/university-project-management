...
const getSingleStudentService = async (id:string): Promise<IStudent |null > => {
...
const updateStudentService = async (id: string, payload: Partial<IAcademicSemester>) :Promise<IAcademicSemester |null> => {
