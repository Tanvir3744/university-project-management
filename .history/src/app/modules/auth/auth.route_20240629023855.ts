...
router.post("/change-password", authValidation(ENUM_USER_ROLE.SUPER_ADMIN, ENUM_USER_ROLE.STUDENT, ENUM_USER_ROLE.ADMIN, ENUM_USER_ROLE.STUDENT, ENUM_USER_ROLE.FACULTY
) , validateRequest(AuthValidation.changePasswordZodSchema), AuthLoginController.changePassword);
